import { getPendingServices, getVerifiedServices } from "@/actions"
...
export const VerifiedServices = () => {
    ...
    const { data, isLoading, error } = useQuery<Services[]>({
        queryKey: ['verified-services'],
        queryFn: getVerifiedServices
    })
        ...
        return (
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>Loading verified services...</CardDescription>
                </CardHeader>
                <CardContent>
            ...
            <Card>
                ...
                <CardContent>
                    <p className="text-sm text-muted-foreground">
                        Failed to load verified services. Please try again.
                    </p>
                </CardContent>
            </Card>
        )
        ...
        return (
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>No verified services</CardDescription>
                </CardHeader>
                <CardContent>
    ...
    return (
        <Card>
            <CardHeader>
                ...
                <CardDescription>
                    All the Verified services by the admin
                </CardDescription>
            </CardHeader>
            <CardContent>
